        ...
        <div className='flex flex-col items-center space-x-0 md:flex-row md:space-x-24'>
          ...
          <div className='flex flex-col items-center justify-center space-y-4 text-center md:items-start md:justify-start md:text-left'>
            ...
            <a
              ...
              target="_blank"
              className='w-40 hover:bg-rome-purple transition-colors bg-rome-100 drop-shadow-[0_10px_8px_rgba(131,20,199,0.25)] rounded-full flex items-center justify-center text-white py-2 font-medium cursor-pointer'
            >
