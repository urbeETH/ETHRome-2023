export default function SponsorZone() {
  return (
    <div
      className='h-screen md:h-auto bg-[#191818] relative pt-8 md:pt-32 pb-48 xl:py-48 pl-0 md:pl-48'
      id='contact'
    >
      <div className='flex flex-col justify-center items-center md:items-start max-w-xl space-y-4 relative'>
