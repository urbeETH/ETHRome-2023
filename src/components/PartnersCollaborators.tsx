    ...
    <div className='pb-16 md:pb-24 bg-[#EFEBE6] flex items-center justify-center'>
      <div className='flex flex-col justify-center items-start md:flex-row w-3xl gap-6'>
        <div className='flex flex-col items-center gap-2'>
          ...
          <div className='partnersCollab_grid gap-4'>
            <div className='partnersCollab_item flex justify-center items-center shrink-0 w-[180px] h-[108px] opacity-60'>
              <Image
            ...
            <div className='partnersCollab_item flex justify-center items-center shrink-0 w-[180px] h-[108px] opacity-60'>
              <a href="https://forwebthree.com/" className='flex justify-center items-center'>
                <img className='md:w-[70%]' src="/partnersCollaborators/logo-forweb3.svg" alt="Logo For Web3" />
              </a>
            </div>
            <div className='partnersCollab_item flex justify-center items-center shrink-0 w-[180px] h-[108px] opacity-60'>
              <Image
            ...
            <div className='partnersCollab_item flex justify-center items-center shrink-0 w-[180px] h-[108px] opacity-60'>
              <Image
                imagePath='/partnersCollaborators/cryptoEvents.png'
                url='https://cryptoevents.xyz/'
                alt='Logo Crypto Events'
              />
            </div>
          </div>
        </div>
        ...
        <div className=' flex flex-col items-center justify-center gap-4 w-full md:w-auto '>
          ...
          <div className='flex flex-col items-center gap-2'>
            <h4 className='font-semibold text-rome-red uppercase'>HACKATHON COLLABORATOR</h4>
            <div className='flex w-[220px] h-[132px] justify-center items-center'>
              <Image
