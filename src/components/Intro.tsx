      ...
      <div className='flex flex-col items-center h-full px-8 space-y-12 justify-evenly md:space-y-0 md:px-0'>
        ...
        <div className='flex space-x-0 md:space-x-24'>
          ...
          <div className='flex flex-col max-w-xs'>
            ...
            <Link to='/article' className='w-full md:w-48 bg-white hover:bg-[#191818] hover:text-white transition-colors rounded-full flex items-center justify-center text-black p-2 font-medium border-2 border-white mt-8' >Read the Full Story</Link>
          </div>
        </div>
      </div>
