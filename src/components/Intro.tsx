...
import Colosseum from '../images/vector/colosseum.svg'
import IconLecture from '../images/vector/icon-lecture.svg'
    ...
    >
      <div className='flex flex-col items-center h-full px-8 space-y-12 justify-evenly md:space-y-0 md:px-0'>
        ...
        <div className='flex space-x-0 md:space-x-24'>
          <Colosseum className='hidden lg:block' />
          <div className='flex flex-col max-w-xs'>
            <div className='relative'>
              <StaticImage
                src='../images/splash_yellow.png'
                alt='splash yellow'
                className='inline-block'
              />
              <IconLecture className='absolute bottom-2 left-4' />
            </div>
      ...
      <div className='absolute right-12 bottom-12 md:bottom-12 md:right-24'>
        <div className='relative'>
          <div className='flex items-center justify-end space-x-2'>
            ...
            <StaticImage src='../images/urbe_logo_white.png' alt='urbe logo white' />
          </div>
